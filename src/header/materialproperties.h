...
inline void predefinedMaterials(QVector<MaterialProperties> &list)
{
    // ---- Gems 宝石 ----
    list.append({"Emerald",
    ...
    list.append({"Brass",
        ...
        {0.992157f, 0.941176f, 0.807843f}, 27.9f});
    ...
    // ---- Plastics 塑料 ----
    list.append({"Black Plastic",
        {0.0f, 0.0f, 0.0f},
        {0.01f, 0.01f, 0.01f},
        {0.50f, 0.50f, 0.50f}, 32.0f});

    list.append({"Cyan Plastic",
        {0.0f, 0.1f, 0.06f},
        {0.0f, 0.50980392f, 0.50980392f},
        {0.50196078f, 0.50196078f, 0.50196078f}, 32.0f});

    list.append({"Green Plastic",
        {0.0f, 0.0f, 0.0f},
        {0.1f, 0.35f, 0.1f},
        {0.45f, 0.55f, 0.45f}, 32.0f});

    list.append({"Red Plastic",
        {0.0f, 0.0f, 0.0f},
        {0.5f, 0.0f, 0.0f},
        {0.7f, 0.6f, 0.6f}, 32.0f});

    list.append({"White Plastic",
        {0.0f, 0.0f, 0.0f},
        {0.55f, 0.55f, 0.55f},
        {0.70f, 0.70f, 0.70f}, 32.0f});

    list.append({"Yellow Plastic",
        {0.0f, 0.0f, 0.0f},
        {0.5f, 0.5f, 0.0f},
        {0.60f, 0.60f, 0.50f}, 32.0f});

    // ---- Rubbers 橡胶 ----
    list.append({"Black Rubber",
        {0.02f, 0.02f, 0.02f},
        {0.01f, 0.01f, 0.01f},
        {0.4f, 0.4f, 0.4f}, 10.0f});

    list.append({"Cyan Rubber",
        {0.0f, 0.05f, 0.05f},
        {0.4f, 0.5f, 0.5f},
        {0.04f, 0.7f, 0.7f}, 10.0f});

    list.append({"Green Rubber",
        {0.0f, 0.05f, 0.0f},
        {0.4f, 0.5f, 0.4f},
        {0.04f, 0.7f, 0.04f}, 10.0f});

    list.append({"Red Rubber",
        {0.05f, 0.0f, 0.0f},
        {0.5f, 0.4f, 0.4f},
        {0.7f, 0.04f, 0.04f}, 10.0f});

    list.append({"White Rubber",
        {0.05f, 0.05f, 0.05f},
        {0.5f, 0.5f, 0.5f},
        {0.7f, 0.7f, 0.7f}, 10.0f});

    list.append({"Yellow Rubber",
        {0.05f, 0.05f, 0.0f},
        {0.5f, 0.5f, 0.4f},
        {0.7f, 0.7f, 0.04f}, 10.0f});
}
